...
import { Database, Search, SlidersHorizontal, Clock, CheckCircle2, ShieldAlert } from 'lucide-react';
...
export default function AdminBookingsPage() {
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 border text-[10px] font-bold uppercase tracking-wider rounded-full ${config.classes}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-5">
            <div>
              ...
              <p className="text-xs text-gray-400 font-semibold uppercase tracking-wider mt-1">Review checkout holds and payment transactions across the system.</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-4 border border-gray-100 rounded-2xl shadow-sm">
            ...
            <div className="relative w-full md:max-w-md">
              ...
              <input
                ...
                className="block w-full pl-10 pr-4 py-2.5 border border-gray-200 focus:border-orange-500 rounded-xl text-xs font-bold focus:outline-none placeholder-gray-400 transition-colors"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <select
                ...
                className="block w-40 px-3.5 py-1.5 bg-white border border-gray-200 focus:border-orange-500 rounded-xl text-xs font-bold focus:outline-none transition-colors cursor-pointer"
              >
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Booking ID</th>
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Travel Package</th>
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Price Allotment</th>
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Status</th>
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Hold Expiration</th>
                      <th className="px-6 py-4.5 text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Created Date</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-50">
                    {filteredBookings.map((booking) => (
                      <tr key={booking._id} className="hover:bg-gray-50/30 transition-colors">
                        <td className="px-6 py-4 text-xs font-mono text-gray-400 font-bold uppercase">
                          #{booking._id}
                        </td>
                        <td className="px-6 py-4">
                          <div className="text-sm font-bold text-gray-900 font-serif-elegant">
                        ...
                        <td className="px-6 py-4 text-xs text-gray-400 font-semibold uppercase">
